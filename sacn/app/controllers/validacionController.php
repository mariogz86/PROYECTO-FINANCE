<?php
	...
	class validacionController extends mainModel{
        ...
        public function listar(){
			...
			$consulta_datos="select * from \"SACNSYS\".obtener_validaciones"; 
		 ...
		 public function buscarformulario($formulario,$anio){
			
			$consulta_datos="select * from \"SACNSYS\".obtener_formulario where anio='".$anio."' and nombre='".$formulario."'"; 
		...
		public function guardarvalidaciones($json){	 
				...
				$sentencia ="select \"SACNSYS\".guardarvalidacionexcel('".$json."',".$_SESSION['id'].");"; 
				$sql=$this->ejecutarConsulta($sentencia);
			...
			public function guardarparametrosexcel($json,$idform){	 
	 			
				$sentencia ="select \"SACNSYS\".guardarparametrosexcel('".$json."',".$idform.") ;"; 
				$sql=$this->ejecutarConsulta($sentencia);
