<?php
	...
	class hojaController extends mainModel{
        ...
        public function listarhoja(){	
			...
			$consulta_datos="select * from \"SYSTEM\".obtener_hoja;"; 
		...
		public function buscarhoja(){
			...
			$consulta_datos="select * from \"SYSTEM\".buscarhoja('".$cmb_formulario."','".$cmb_hoja."','".$_POST["idhoja"]."');"; 
		...
		public function guardar(){
			...
			if ($_POST["idhoja"]=="0"){
				$sentencia ="select \"SYSTEM\".insertar_hoja('".$cmb_formulario."','".$cmb_hoja."','".$_SESSION['id']."');";
				$sql=$this->actualizarDatos($sentencia);
 				$sql->execute();
			  
					
			}else{
				$sentencia ="select \"SYSTEM\".actualizar_hoja('".$_POST["idhoja"]."','".$cmb_formulario."','".$cmb_hoja."','".$_SESSION['id']."');";
				$sql=$this->actualizarDatos($sentencia);
				$sql->execute();	
		...
		public function cambiarestado($estado){ 
			...
			$idhoja = $_POST["id_hoja"];
				$sentencia ="select \"SYSTEM\".cambiarestado_hoja('".$idhoja."','".$estado."','".$_SESSION['id']."');";
				$sql=$this->actualizarDatos($sentencia);
				$sql->execute(); 
