            ...
            <div class="columns ">
                ...
                <div class="column">
                    <div class="control ">
                        ...
                        <?php
                             $catalogo =$insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='coinvar'"); 
                        
                        $consulta_datos="select * from \"SACNSYS\".obtener_valor_porcatalogo('coinvar' ) where estado=1 order by nombre ;"; 
    ...
    <div name="gridcat">
        ...
        <p class="has-text-centered">
            ...
            <button name="btnreclasificar" type="submit" class="button is-info is-rounded"><i class="fas fa-search"></i>
                ...
                <button name="btncomparar" type="submit" class="button is-info is-rounded"><i class="far fa-file-code"></i>
                &nbsp;
                variables vs fuente</button>
...
const btncomparar = document.getElementsByName("btncomparar");
...
$("#titulo")[0].innerText = "Esta pantalla permite agregar e inactivar las variables de los archivos .SAV asociadas a una Hoja y formulario del sistema. ";
...
btncomparar[0].addEventListener("click", (event) => {
    ...
    if (selectarchivo != "" && selectarchivo != undefined) {
        ...
        if (selecthoja != "" && selecthoja != undefined) {
            ...
            $.ajax({
                ...
                data: "comparar=cargar&formulario=" +
                    selectform + "&hoja=" +
                    selecthoja + "&archivo=" +
                    selectarchivo,
