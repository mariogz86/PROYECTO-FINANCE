...
if(isset($_GET['cargagrid']))
    ...
    if(isset($_GET['cargarhojas']))
	{
        //se valida si se envia algun valor en el metodo
            if($_GET['cargarhojas']!=""){
                ...
                $datos=$funciones->ContarRegistros("select * from \"SYSTEM\".obtener_hoja where id_formulario=".$_GET['cargarhojas']." and u_estado=1");
                $contararchivos=$funciones->ContarRegistros("select * from \"SYSTEM\".obtener_archivofuente where id_formulario=".$_GET['cargarhojas']." and u_estado=1");
    ...
    if(isset($_GET['varnuevas']))
	{
        ...
        $contararchivos=$funciones->ContarRegistros("select * from \"SYSTEM\".obtener_variable where id_formulario=".$_GET['formulario']." and id_hoja=".$_GET['hoja']." and id_archivofuente=".$_GET['archivo']."");
        $variables = array();
