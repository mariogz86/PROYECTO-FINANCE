    ...
    <form name="formformulario" class="FormularioAjax " action="<?php echo APP_URL; ?>ajax/formularioAjax.php"
        ...
        <div class="col-sm-12 col-md-10">
            <div class="columns ">
                <div class="col-sm-12 col-md-6">
                    <div class="control ">
                        ...
                        $consulta_datos="select * from \"SACNSYS\".obtener_valor_porcatalogo('anio' ) where estado=1;"; 
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="control ">
                        ...
                        <?php
                             $catalogo =$insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='tipfor' "); 
                        
                        $consulta_datos="select * from \"SACNSYS\".obtener_valor_porcatalogo('tipfor' ) where estado=1;"; 
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="control ">
                        ...
                        $consulta_datos="select * from \"SACNSYS\".obtener_valor_porcatalogo('actividad' )  where estado=1;"; 
            ...
            <div class="columns">
                <div class="col-sm-12 col-md-6">
                    <div class="control">
                        <label>Nombre <?php echo CAMPO_OBLIGATORIO.' archivo con formato .xlsx'; ?></label>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="control ">
                        ...
                        <?php
                             $catalogo =$insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='tdencu'  ;"); 
                        
                        $consulta_datos="select * from \"SACNSYS\".obtener_valor_porcatalogo('tdencu' ) where estado=1;"; 
...
regresar[0].addEventListener("click", (event) => {
    ...
    $("#titulo")[0].innerText = "Esta pantalla permite agregar o modificar un formulario de encuesta. (plantilla en formato excel ubicado dentro de la carpeta ../carga_archivos/...ruta)";
    $('.form-select').prop("selectedIndex", 0);
    $('.form-select').change();
    $("#combodetalle")[0].style.display = "none";
