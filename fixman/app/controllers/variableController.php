<?php
	...
	class variableController extends mainModel{
        ...
        public function listarvariable(){
			...
			$consulta_datos="select * from \"SYSTEM\".obtener_variable where id_formulario=".$_GET["formulario"]." and id_hoja=".$_GET["hoja"]." and id_archivofuente=".$_GET["archivo"]." "; 
        ...
        public function obtenerhojas($idform){
			...
			$consulta_datos="select * from \"SYSTEM\".obtener_hoja where id_formulario=".$idform." and u_estado=1"; 
        ...
        public function obtenerarchivosfuente_por_id($id){
			...
			$consulta_datos="select * from \"SYSTEM\".obtener_archivofuente  where id_archivofuente='".$id."';"; 
		...
		public function guardar($json){
			...
			$consulta_datos="select \"SYSTEM\".guardarvariables(".$_POST["formulario"].",".$_POST["hoja"].",".$_POST["archivo"].",".$_POST["coincidir"].",'".$json."',".$_SESSION['id'].");"; 
		...
		public function actualizarvar($json){
			...
			$consulta_datos="select \"SYSTEM\".actualizarvariables('".$json."',".$_POST["coincidir"].",".$_SESSION['id'].");"; 
		...
		public function cambiarestado($estado){ 
			...
			$idcat = $_POST["id_variable"];
				$sentencia ="select \"SYSTEM\".cambiarestado_variable('".$idcat."','".$estado."','".$_SESSION['id']."');";
