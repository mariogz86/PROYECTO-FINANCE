			...
			<ul class="full-width list-unstyle menu-principal">
				...
				<li class="full-width">
					<a href="#" class="full-width btn-subMenu">
						...
						<ul class="full-width menu-principal sub-menu-options">
							...
							<li class="full-width divider-menu-h"></li>
							<li class="full-width"> <!--MEnu Clientes-->
								<a href="#" class="full-width btn-subMenu">
									<div class="navLateral-body-cl">
				...
				<li class="full-width">
					...
					<li class="full-width">
							...
							<ul class="full-width menu-principal sub-menu-options">
							<li class="full-width">
									<a href="<?php echo APP_URL; ?>rolNew/" class="full-width">
										<div class="navLateral-body-cl">
								...
								<li class="full-width">
									<a href="<?php echo APP_URL; ?>rolList/" class="full-width">
										<div class="navLateral-body-cl">
											<i class="fas fa-clipboard-list fa-fw"></i>
										</div>
										<div class="navLateral-body-cr">
						...
						<li class="full-width">
							...
							<ul class="full-width menu-principal sub-menu-options">
							<li class="full-width">
									<a href="<?php echo APP_URL; ?>menuNew/" class="full-width">
										<div class="navLateral-body-cl">
								...
								<li class="full-width">
									<a href="<?php echo APP_URL; ?>menuList/" class="full-width">
										<div class="navLateral-body-cl">
											<i class="fas fa-clipboard-list fa-fw"></i>
										</div>
										<div class="navLateral-body-cr">
						...
						<li class="full-width">
							...
							<ul class="full-width menu-principal sub-menu-options">
							<li class="full-width">
									<a href="<?php echo APP_URL; ?>opcionNew/" class="full-width">
										<div class="navLateral-body-cl">
								...
								<li class="full-width">
									<a href="<?php echo APP_URL; ?>opcionList/" class="full-width">
										<div class="navLateral-body-cl">
											<i class="fas fa-clipboard-list fa-fw"></i>
										</div>
										<div class="navLateral-body-cr">
