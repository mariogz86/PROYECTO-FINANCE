<?php
	...
	class cargaController extends mainModel{
        ...
        public function obtenerarchivosfuentes_poridarchivo($id){
          ...
          $consulta_datos="select * from \"SACNSYS\".obtener_archivofuente  where id_archivofuente='".$id."' and u_estado=1;"; 
		...
		public function guardar($json,$nuevas,$formulario){
			
			$consulta_datos="select \"SACNSYS\".GUARDARVALORVARIABLES('".$json."',".$nuevas.",".$formulario.",".$_SESSION['id'].");"; 
