...
regresar[0].addEventListener("click", (event) => {
    ...
    $("#titulo")[0].innerText = "Esta pantalla permite agregar, modificar e inactivar un menu del sistema.";
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if (row.u_estado == 0) {
                                return '<td><form class="FormularioAjax" action="<?php  echo APP_URL?>ajax/menuAjax.php" method="POST" autocomplete="off" >' +
