<style>
    ...
    /* Estilo más claro para los placeholders */
    ::placeholder {
    ...
    /* También funciona en los inputs con fondo oscuro */
    input.form-control:focus::placeholder {
        color: rgba(0, 0, 0, 0.25);
        /* Más tenue al enfocar */
    }

    .progress.custom-border {
        border: 1px solid #080808ff !important;
        /* Verde éxito (o el color que quieras) */
        border-radius: 0.375rem !important;
        /* Opcional: igual al de Bootstrap */
    }
</style>
<?php
...
<div class="container">
    ...
    <div id="asistente" name="asistente" class="container py-5" style="display: none; background: #0000001f;padding: 5px;border-radius: 20px;">


        <!-- Barra de progreso -->
        <div class="progress mb-4 custom-border">
            <div class="progress-bar progress-bar-striped bg-success" id="progressBar"
                role="progressbar" style="width: 33.33%;color:#191818;font-weight: bold;" aria-valuenow="33" aria-valuemin="0" aria-valuemax="100">
                Job
            </div>
        </div>
        <!-- Paso 1 -->
        <div class="step active" data-step="1">
            ...
            <form name="formCompany" class="FormularioAjaxjob" action="<?php echo APP_URL; ?>ajax/jobAjax.php" method="POST"
...
<script>
    ...
    const terminar = document.getElementsByName("terminar");
    ...
    const asistente = document.getElementsByName("asistente");
    ...
    function showStep(step) {
        ...
        switch (step) {
            case 1:
                progressBar.innerText = `Job`;
                break;
            case 2:
                progressBar.innerText = `Services`;
                break;
            case 3:
                progressBar.innerText = `Appointment schedule`;
                break;
            case 4:
                progressBar.innerText = `Payment information`;
                break;
            default:
                progressBar.innerText = `Resumen`;
        }
    ...
    function pantallaprincipal() {
        ...
        asistente[0].style.display = "none";
    ...
    terminar[0].addEventListener("click", (event) => {
        event.preventDefault();
        cargargrid();
    });
    ...
    function cargaformularioservicio(expandirformulario) {
        ...
        cargajob(idjob_service[0].value);
    }
