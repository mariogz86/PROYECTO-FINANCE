...
//declaracion de metodos del controlador
	class archivoController extends mainModel{
        ...
        public function listararchivo(){
			...
			$consulta_datos="select * from \"SYSTEM\".obtener_archivofuente;"; 
        ...
        public function buscararachivo_porformulario($id){
			...
			$consulta_datos="SELECT * FROM \"SYSTEM\".obtener_archivofuente where id_formulario=".$id.";"; 
		...
		public function guardar($json){
			...
			$consulta_datos="select \"SYSTEM\".guardararchivosfuente(".$_POST["formulario"].",'".$json."',".$_SESSION['id'].");"; 
		...
		public function guardar_cambioruta(){
			...
			$sentencia ="select \"SYSTEM\".cambiar_ruta('".$idseleccionados."','".$ruta."','".$_SESSION['id']."');";
		...
		public function cambiarestado($estado){ 
			...
			$idcat = $_POST["id_archivofuente"];
				$sentencia ="select \"SYSTEM\".cambiarestado_archivo('".$idcat."','".$estado."','".$_SESSION['id']."');";
				$sql=$this->actualizarDatos($sentencia);
				$sql->execute(); 
