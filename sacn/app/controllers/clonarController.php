<?php
	...
	class clonarController extends mainModel{
		...
		public function buscarformulario($cmb_anio,$cmb_tipocarga,$cmb_catatividad,$cmb_detactiv,$cmb_tipoencuesta,$nombre){ 
			...
			$consulta_datos="select * from \"SACNSYS\".buscarformulario('".$cmb_detactiv."','".$nombre."','".$cmb_tipoencuesta."','".$cmb_anio."' ,'".$cmb_tipocarga."','".$cmb_catatividad."','0');"; 
		...
		public function clonar($idformulario,$idformnuevo,$anio){ 
				...
				$sentencia ="select \"SACNSYS\".clonarformulario('".$anio."','".$idformulario."','".$idformnuevo."','".$_SESSION['id']."');";
		...
		public function borrarformulario($idformulario){ 
			...
			$sentencia ="select \"SACNSYS\".borrarformulario('".$idformulario."');";
			$sql=$this->actualizarDatos($sentencia);
			$sql->execute();  
