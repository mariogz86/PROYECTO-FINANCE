<?php
	...
	class formularioController extends mainModel{
		...
		public function buscarformulario(){
			...
			$consulta_datos="select * from \"SACNSYS\".buscarformulario('".$cmb_detactiv."','".$nombre."','".$cmb_tipoencuesta."','".$cmb_anio."' ,'".$cmb_tipocarga."','".$cmb_catatividad."','".$_POST["idformulario"]."');"; 
		...
		public function listardetalleactividad($codicatalogo){
			$consulta_datos="select * from \"SACNSYS\".obtener_valor_porcatalogo('".$codicatalogo."' );"; 
		...
		public function guardar(){
			...
			if ($_POST["idformulario"]=="0"){
				$sentencia ="select \"SACNSYS\".insertar_formulario('".$cmb_anio."','".$cmb_tipoencuesta."','".$cmb_tipocarga."','".$cmb_catatividad."','".$cmb_detactiv."','".$nombre."','".$ruta."','".$_SESSION['id']."');";
				$sql=$this->actualizarDatos($sentencia);
 				$sql->execute();
			  
					
			}else{
				$sentencia ="select \"SACNSYS\".actualizar_formulario('".$_POST["idformulario"]."','".$cmb_tipoencuesta."','".$cmb_anio."','".$cmb_tipocarga."','".$cmb_catatividad."','".$cmb_detactiv."','".$nombre."','".$ruta."','".$_SESSION['id']."');";
				$sql=$this->actualizarDatos($sentencia);
				$sql->execute();	
		...
		public function guardar_cambioruta(){
			...
			$sentencia ="select \"SACNSYS\".actualizar_ruta('".$idseleccionados."','".$ruta."','".$_SESSION['id']."');";
			$sql=$this->actualizarDatos($sentencia);
 			$sql->execute();	  
		 return $sql;
		}
