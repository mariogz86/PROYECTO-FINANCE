    ...
    <form name="formvalidacion" class="FormularioAjax"
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="columns">
                <div class="col-sm-12 col-md-8">
                    <div class="control">
                        <label>Formula<?php echo CAMPO_OBLIGATORIO; ?></label>
                        <textarea name="formula" class="input" style="height: 50px;" required></textarea>
                    </div>
                </div>
            </div>
            <div class="columns">
                ...
                <div class="column">
                    <div class="control ">
                        ...
                        <?php
                        $catalogo = $insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='tipval'");

                        $consulta_datos = "select * from \"SACNSYS\".obtener_valor_porcatalogo('tipval' ) where estado=1;";
                ...
                <div class="column">
                    <div class="control ">
                        ...
                        <?php
                        $catalogo = $insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='condic'");

                        $consulta_datos = "select * from \"SACNSYS\".obtener_valor_porcatalogo('condic' ) where estado=1;";
            ...
            <div class="columns">
                ...
                <div class="column">
                    <div class="control ">
                        ...
                        <?php
                        $catalogo = $insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='param'");

                        $consulta_datos = "select * from \"SACNSYS\".obtener_valor_porcatalogo('param' ) where estado=1;";
                ...
                <div class="column">
                    <div class="control ">
                        ...
                        <?php
                        $catalogo = $insrol->ejecutarconsultaarreglo("select c.* from  \"SACNSYS\".catalogo c  where c.codigo='tipvalor'");

                        $consulta_datos = "select * from \"SACNSYS\".obtener_valor_porcatalogo('tipvalor' ) where estado=1;";
...
$("#titulo")[0].innerText =
    "Esta pantalla permite agregar, modificar e inactivar las validaciones que se definan para un formulario. ";
        ...
        if (selectedFile) {
            ...
            fileReader.onload = function(event) {
                ...
                if (validaciones.length == 0) {
                    ...
                    let jsonvalidaciones = JSON.stringify(validaciones).replaceAll("&", "%26");
                    ...
                    let jsonparametros = JSON.stringify(parametros).replaceAll("&", "%26");
                    ...
                    $.ajax({
                        ...
                        data: "guardarcarga=excel&validaciones=" + encodedData + "&parametros=" +
                            jsonparametros + "&formulario=" + validaciones[0].formulario.trim() +
                            "&anio=" + validaciones[0].año,
                            ...
                            if (res.status == 200) {
                                ...
                                if (res.status == 404) {
                                    Swal.fire({
                                        icon: "warning",
                                        title: "Carga",
                                        text: "no se guardaron los parametros, favor contacte al administrador",
                                        confirmButtonText: 'Aceptar'
                                    });
                                }
...
function cargarformularioparametro(alerta) {
    ...
    if (array.texto == "Carga con error en parametros, por favor validar") {
        cargargridparametroserror(array.data);
    } else {
...
$(document).on('click', '#modificar', function(e) {
    ...
    document.getElementsByName("formula")[0].value = dato.formula;
