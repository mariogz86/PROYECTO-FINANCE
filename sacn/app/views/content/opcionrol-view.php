...
<div class="container">
    ...
    <h2 class="subtitle"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; <label id="titulo">Esta pantalla permite asociar e inactivar una opción a un rol del sistema.</label></h2>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="columns ">
                ...
                <div class="control ">
                        ...
                        $consulta_datos="select * from \"SACNSYS\".obtener_opcionmenu where u_estado=1 and nombrevista not in('opcionrol');"; 
